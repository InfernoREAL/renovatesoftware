...
var AppComponent = (function () {
    function AppComponent(overlayContainer, store, router, titleService) {
        ...
        this.navigation = [
            ...
            { link: 'features', label: 'Tutorial' },
            { link: 'examples', label: 'Interview' },
