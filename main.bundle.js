...
var AppComponent = (function () {
    function AppComponent(overlayContainer, store, router, titleService) {
        ...
        this.navigation = [
            ...
            { link: 'features', label: 'Services' },
            { link: 'tutorials', label: 'Tutorials' },
            { link: 'interview', label: 'Interview' },
