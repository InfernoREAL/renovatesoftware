...
module.exports = "<div class=\"container\">\n\n  <div class=\"row\">\n    <div class=\"col-md-12\">\n      <h1 class=\"main-heading\">Tutorials</h1>\n    </div>\n  </div>\n\n  <!-- Web Technology -->\n  <div>\n    <h2>Web Technology</h2>\n    <hr>\n    <div class=\"row align-items-end\">\n      <div class=\"col-md-6 col-lg-4\" [ngClass]=\"animateOnRouteEnter\" *ngFor=\"let tutorial of tutorials.web_development;\">\n        <mat-card>\n          <mat-card-title>\n            <code>{{ tutorial.version }}</code>{{ tutorial.name }}</mat-card-title>\n          <mat-card-subtitle>\n            <a [href]=\"tutorial.developer_profile\" target=\"_blank\">{{ tutorial.developed_by }}</a>\n          </mat-card-subtitle>\n          <mat-card-content>\n            {{ tutorial.description }}\n          </mat-card-content>\n          <mat-card-actions>\n            <a mat-button *ngFor=\"let action of tutorial.actions;\">\n              <i class=\"fa fa-book fa-lg\"></i> {{ action.text }}\n            </a>\n          </mat-card-actions>\n        </mat-card>\n      </div>\n    </div>\n  </div>\n\n  <!-- Node.js Technology -->\n  <div class=\"mt-4\">\n    <h2>Node.js Technology</h2>\n    <hr>\n    <div class=\"row align-items-end\">\n      <div class=\"col-md-6 col-lg-4\" [ngClass]=\"animateOnRouteEnter\" *ngFor=\"let tutorial of tutorials.nodejs_technology;\">\n        <mat-card>\n          <mat-card-title>\n            <code>{{ tutorial.version }}</code>{{ tutorial.name }}</mat-card-title>\n          <mat-card-subtitle>\n            <a [href]=\"tutorial.developer_profile\" target=\"_blank\">{{ tutorial.developed_by }}</a>\n          </mat-card-subtitle>\n          <mat-card-content>\n            {{ tutorial.description }}\n          </mat-card-content>\n          <mat-card-actions>\n            <a mat-button *ngFor=\"let action of tutorial.actions;\">\n              <i class=\"fa fa-book fa-lg\"></i> {{ action.text }}\n            </a>\n          </mat-card-actions>\n        </mat-card>\n      </div>\n    </div>\n  </div>\n\n  <!-- Java Technology -->\n  <div class=\"mt-4\">\n    <h2>Java Technology</h2>\n    <hr>\n    <div class=\"row align-items-end\">\n      <div class=\"col-md-6 col-lg-4\" [ngClass]=\"animateOnRouteEnter\" *ngFor=\"let tutorial of tutorials.java_technology;\">\n        <mat-card>\n          <mat-card-title>\n            <code>{{ tutorial.version }}</code>{{ tutorial.name }}</mat-card-title>\n          <mat-card-subtitle>\n            <a [href]=\"tutorial.developer_profile\" target=\"_blank\">{{ tutorial.developed_by }}</a>\n          </mat-card-subtitle>\n          <mat-card-content>\n            {{ tutorial.description }}\n          </mat-card-content>\n          <mat-card-actions>\n            <a mat-button *ngFor=\"let action of tutorial.actions;\">\n              <i class=\"fa fa-book fa-lg\"></i> {{ action.text }}\n            </a>\n          </mat-card-actions>\n        </mat-card>\n      </div>\n    </div>\n  </div>\n\n  <!-- BIG DATA & ANALYTICS -->\n  <div class=\"mt-4 mb-5\">\n      <h2>Big Data & Analytics</h2>\n      <hr>\n      <div class=\"row align-items-end\">\n        <div class=\"col-md-6 col-lg-4\" [ngClass]=\"animateOnRouteEnter\" *ngFor=\"let tutorial of tutorials.bigdata;\">\n          <mat-card>\n            <mat-card-title>\n              <code>{{ tutorial.version }}</code>{{ tutorial.name }}</mat-card-title>\n            <mat-card-subtitle>\n              <a [href]=\"tutorial.developer_profile\" target=\"_blank\">{{ tutorial.developed_by }}</a>\n            </mat-card-subtitle>\n            <mat-card-content>\n              {{ tutorial.description }}\n            </mat-card-content>\n            <mat-card-actions>\n              <a mat-button *ngFor=\"let action of tutorial.actions;\">\n                <i class=\"fa fa-book fa-lg\"></i> {{ action.text }}\n              </a>\n            </mat-card-actions>\n          </mat-card>\n        </div>\n      </div>\n    </div>\n\n</div>"
        ...
        this.tutorials = {
            web_development: [
                {
                    name: 'HTML',
                    version: 'HTML 5',
                    developed_by: 'W3C & WHATWG',
                    developer_profile: 'https://en.wikipedia.org/wiki/WHATWG',
                    description: 'HTML is a language for building web pages.',
                    actions: [
                        { text: 'Learn HTML', url: '' },
                        { text: 'Interview Q/A', url: '' }
                    ]
                },
                {
                    name: 'CSS',
                    version: 'Initial release',
                    developed_by: 'Håkon Wium Lie; Bert Bos; W3C',
                    developer_profile: 'https://en.wikipedia.org/wiki/WHATWG',
                    description: 'CSS is a language used for styling web pages.',
                    actions: [
                        { text: 'Learn CSS', url: '' },
                        { text: 'Interview Q/A', url: '' }
                    ]
                },
                {
                    ...
                    developer_profile: 'https://en.wikipedia.org/wiki/Brendan_Eich',
                    description: 'The language for programming web pages & backend.',
                    actions: [
                        { text: 'Learn Javascript', url: '' },
                        { text: 'Interview Q/A', url: '' }
                    ]
                },
                {
                    name: 'Typescript',
                    version: 'v2.8.1',
                    developed_by: 'Microsoft Corporation',
                    developer_profile: 'https://en.wikipedia.org/wiki/Microsoft',
                    description: 'TypeScript is designed for development of large applications and transpile to JavaScript.',
                    actions: [
                        { text: 'Learn Typescript', url: '' },
                        { text: 'Interview Q/A', url: '' }
                    ]
                },
                {
            ...
            java_technology: [
                {
                    ...
                    developer_profile: 'https://en.wikipedia.org/wiki/James_Gosling',
                    description: 'Java is a high level, robust, secured and object-oriented programming language.',
                    actions: [
                        { text: 'Learn JAVA', url: '' },
                        { text: 'Interview Q/A', url: '' }
                    ]
                },
                {
                    name: 'Spring',
                    version: '5.0.4',
                    developed_by: 'Rod Johnson',
                    developer_profile: 'https://en.wikipedia.org/wiki/James_Gosling',
                    description: 'The Spring is an application framework for the Java platform.',
                    actions: [
                        { text: 'Learn JAVA', url: '' },
                        { text: 'Interview Q/A', url: '' }
                    ]
            ...
            nodejs_technology: [
                {
                    ...
                    developer_profile: 'https://en.wikipedia.org/wiki/Ryan_Dahl',
                    description: 'Node.js is a JavaScript run-time environment that executes JavaScript code server-side.',
                    actions: [
                        { text: 'Learn Node.js', url: '' },
                        { text: 'Interview Q/A', url: '' }
                    ]
                }
            ],
            bigdata: [
                ...
                },
                {
                    ...
                    version: '',
                    developed_by: 'Arthur Samuel',
                    developer_profile: 'https://en.wikipedia.org/wiki/Arthur_Samuel',
                    description: 'Machine learning is a field of computer science that give computer systems the ability to "learn" with data, without being explicitly programmed.',
                    actions: [
                        { text: 'Machine Learning', url: '' },
                        { text: 'Interview Q/A', url: '' }
                    ]
                }
            ]
